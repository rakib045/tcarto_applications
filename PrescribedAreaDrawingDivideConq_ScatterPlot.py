...
square_grid = 64
input_data_file = 'input/cluster_4_grid_64_64_v2.txt'
output_img_filename = 'output_DivCon_cluster_4_grid_64_64_v2'
...
if __name__ == "__main__":
    ...
    poly_draw_grid_color_wtih_scale(output_img_filename+"_color_grid_", str(iteration) + "_stage" + str(int(m.log(grid_count_horizontal_actual, 2))),
                         output_image_size, nodes, values, grid_count_horizontal_actual, grid_count_vertical_actual)
