...
input_node_data_file = "Datasets/Applications/mosaic/Fast Flow/Image_5/final_nodes_image5_128_128.csv"
input_weight_data_file = "Datasets/Applications/mosaic/Fast Flow/Image_5/vinci_weight_128_128.txt"

output_filename = 'output_mosaic_fastflow_vinci_128_128'
square_grid = 128
...
if __name__ == "__main__":
    ...
    poly_draw_color_for_maxflow("output/" + output_filename + "_polygon.png", output_image_size, nodes, grid_horiz, grid_vert)
