...
input_node_data_file = "Datasets/Applications/lowlightdessimate/FastFlow/image3/fastflow_output/final_nodes_image3.csv"
input_weight_data_file = "Datasets/Applications/lowlightdessimate/FastFlow/image3/input/image3_lightness_weight_64_64.txt"

output_filename = 'output_lightness_image3_64_64'
square_grid = 64
output_image_size = [512, 512]

is_image_output = True
input_img_file = "Datasets/Applications/lowlightdessimate/FastFlow/image3/input/image3.png"
