...
square_grid = 64
input_data_file_area = 'input/image3_lightness_weight_64_64.txt'
output_img_filename = 'output_DivCon_image3_lightness'
input_img_file = "input/image3.png"
...
if __name__ == "__main__":
    ...
    values_actual = read_text_file(input_data_file_area, grid_count_horizontal_actual, grid_count_vertical_actual)
    values_actual_in_order = read_text_file_actual_order(input_data_file_area, grid_count_horizontal_actual,
                                                         grid_count_vertical_actual)

    # values_actual_sat = read_text_file_actual_order(input_data_file_saturation, grid_count_horizontal_actual, grid_count_vertical_actual)
    # values_actual_light = read_text_file_actual_order(input_data_file_light, grid_count_horizontal_actual, grid_count_vertical_actual)
    ...
    image_processing_time_start = time()
    output_image_path = imageDrawLightChannelTopToBottom_HLS_new(input_img_file, nodes, values,
                                                             output_img_filename, grid_count_horizontal_actual,
                                                             grid_count_vertical_actual)
    image_processing_time_end = time()
    p_time = image_processing_time_end - image_processing_time_start
    print("Image Processing Time : " + str(round(p_time, 4)))

    output_txt_file = open(out_file_name, "a")
    output_txt_file.write("\n\nImage Processing Time : " + str(round(p_time, 4)))
